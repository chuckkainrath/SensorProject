...
func (t thresholdService) GetSensorThreshold(sensorId uint, userId uint) (*models.Threshold, *errors.AppError) {
	c, err := t.ThresholdRepo.GetSensorThreshold(sensorId, userId)
	if err != nil {
		return nil, err
	}
